...
//      cy.exec('node /path/to/server/destroy.js');
    ...
    it('2.4.2 | Logs in and asks a question with new tag without enough rep', () => {
        ...
        cy.get('#formTitleInput').type('Unit Test Question Title');
        cy.get('#formTextInput').type('Unit Test Question Text');
        cy.get('#formTagInput').type('photons');
        cy.contains('Post Question').click();
    ...
    it('2.7.3 | Ask Question with text more than 100 characters', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt')
        cy.get('#password').type('Password_123')
        cy.contains('Log In').click();
        ...
        cy.contains('Ask a Question').click();
        cy.get('#formTitleInput').type('y'.repeat(101));
        cy.get('#formTextInput').type('Test Question 1 Text Q1');
        cy.get('#formTagInput').type('javascript');
        cy.contains('Post Question').click();
    ...
    it('2.7.4 | Asks Question with more than 5 tags', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt')
        cy.get('#password').type('Password_123')
        cy.contains('Log In').click();
        ...
        cy.get('#formTitleInput').type('Test Question 1 Text Q1');
        cy.get('#formTextInput').type('Test Question 1 Text Q1');
        cy.get('#formTagInput').type('javascript quantum atom electrons particles node');
        cy.contains('Post Question').click();
        cy.contains('Cannot have more than 5 tags');
    });

    it('2.7.5 | Asks Question with tag length more than 20', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt')
        cy.get('#password').type('Password_123')
        cy.contains('Log In').click();
        ...
        cy.get('#formTitleInput').type('Test Question 1 Text Q1');
        cy.get('#formTextInput').type('Test Question 1 Text Q1');
        cy.get('#formTagInput').type('javascriptquantumatomelectronsparticlesnode');
        cy.contains('Post Question').click();
        cy.contains('Tag length cannot be more than 20');
    });

    it('2.7.6 | Ask Question, Invalid Hyperlink', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
        ...
        cy.contains('Ask a Question').click();
        cy.get('#formTitleInput').type('Test Question 1 Text Q1');
        cy.get('#formTextInput').type('This is a question with an invalid [link](http://invalid-link)');
        cy.get('#formTagInput').type('javascript');
        cy.contains('Post Question').click();
        cy.contains('Invalid hyperlink').should('exist');
    });
    ...
    it('5.1.1 | View Questions, Sort by Active', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt')
        cy.get('#password').type('Password_123')
        cy.contains('Log In').click();
        ...
        cy.contains('Question Title 5').click();
        cy.contains('Answer Question').click();
        ...
        cy.contains('Questions').click();
        cy.contains('Active').click();
        cy.contains('Question Title 5');
    });

    it('5.1.2 | View Questions, Sort by Unanswered', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('jdalt')
        cy.get('#password').type('Password_123')
        cy.contains('Log In').click();
    ...
    it('5.3.2 | Add Answer to Question, Invalid Hyperlink', () => {
        ...
        cy.get('button.submit-button').click();
        cy.contains('Invalid hyperlink constraints').should('exist');
    });
    ...
    it('10.3 | Profile, Edit Question and see Changes', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
    ...
    it('10.4 | Profile, Edit Answer and see Changes ', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
    ...
    it('10.5 | Profile, Edit Tag and see Changes ', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
    ...
    it('10.6 | Profile, Delete Question and see Changes', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
        ...
        cy.get('.profile-container').contains('Questions').click();
        cy.contains('2 Questions')
        cy.contains('Question Title 8').click()
    ...
    it('10.7 | Profile, Delete Answer and see Changes ', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
    ...
    it('10.8 | Profile, Delete Tag and see Changes ', () => {
        cy.visit('http://localhost:3000');
        cy.get('#username').type('wheisenberg');
        cy.get('#password').type('Password_123');
        cy.contains('Log In').click();
    ...
    it('12.0 | Accept an answer', () => {
        ...
        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 1');
        cy.get('button.submit-button').click();

        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 2');
        cy.get('button.submit-button').click();

        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 3');
        cy.get('button.submit-button').click();

        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 4');
        cy.get('button.submit-button').click();

        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 5');
        cy.get('button.submit-button').click();

        cy.contains('Answer Question').click();
        cy.get('#answerTextInput').type('Answer 6');
        cy.get('button.submit-button').click();
